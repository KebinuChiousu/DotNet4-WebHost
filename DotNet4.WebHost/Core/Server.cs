...
using System.Web;
using System.Web.Hosting;
using DotNet4.WebHost.Configuration;
using DotNet4.WebHost.Logging;
using DotNet4.WebHost.Misc;

#endregion

namespace DotNet4.WebHost.Core
{
    ///<summary>
    ///</summary>
    ...
    public class Server : MarshalByRefObject, IDisposable
    {
                      ...
                      bool disableDirectoryListing)
        {
            ...
            ApplicationManager = System.Web.Hosting.ApplicationManager.GetApplicationManager();
